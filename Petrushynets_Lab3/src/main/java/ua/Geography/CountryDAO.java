...
public class CountryDAO {
	...
	// Insert (Create)
	public void insertCountry(int country_id, String country_name, int population) {
	...
	// Update
	public void updateCountry(int country_id, String country_name, int population) {
